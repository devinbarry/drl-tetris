...
config['rollout_fragment_length'] = 500  # Size of batches collected from each worker.
...
config['sgd_minibatch_size'] = 1024  # Default is 128.
config['num_sgd_iter'] = 30


agent = PPOTrainer(config, "TetrisA-v1")
